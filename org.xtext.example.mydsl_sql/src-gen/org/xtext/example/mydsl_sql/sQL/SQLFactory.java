...
public interface SQLFactory extends EFactory
{
   ...
   * @generated
   */
  SQLFactory eINSTANCE = org.xtext.example.mydsl_sql.sQL.impl.SQLFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Case Operand</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Case Operand</em>'.
   * @generated
   */
  SQLCaseOperand createSQLCaseOperand();

  /**
   * Returns a new object of class '<em>Case Whens</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Case Whens</em>'.
   * @generated
   */
  SQLCaseWhens createSQLCaseWhens();

  /**
   * Returns a new object of class '<em>Sql Case When</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Sql Case When</em>'.
   * @generated
   */
